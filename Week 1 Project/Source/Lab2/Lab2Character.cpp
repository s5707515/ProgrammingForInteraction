...
{	
	...
	{
		// Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &ALab2Character::DoJumpStart);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &ALab2Character::DoJumpEnd);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ALab2Character::MoveInput);
...
void ALab2Character::LookInput(const FInputActionValue& Value)
{
...
void ALab2Character::DoAim(float Yaw, float Pitch)
{
	if (GetController())
	{
...
void ALab2Character::DoMove(float Right, float Forward)
{
	if (GetController())
	{
...
void ALab2Character::DoJumpStart()
{
	// pass Jump to the character
	Jump();
}

void ALab2Character::DoJumpEnd()
{
