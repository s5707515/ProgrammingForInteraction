 ...
 */
UCLASS(abstract)
class LAB2_API AShooterNPC : public ALab2Character, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
public:
	...
	virtual int GetAmmoCount() { return 100; }

	virtual void AdjustAmmoCount(int _value) {}
